...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/SuzukiRyota/SimpleBoard/sqlite.db'
    }
}
...
SECRET_KEY = '^gy7e@#x5@5e4b4#e8tm&amp;nciw-k&amp;#nwt+e1+cc$c#+tbp1a$v6'
...
MIDDLEWARE_CLASSES = (
    'SimpleBoard.middleware.log_print.PrintHeaderMiddleware',
